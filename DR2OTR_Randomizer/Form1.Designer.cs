namespace DR2OTR_Randomizer
{
    partial class F_ItemRandomiser
    {
        ...
        private void InitializeComponent()
        {
            ...
            tsm_ItemDataFile.Size = new Size(207, 22);
            ...
            // bt_Pack
            // 
            bt_Pack.Location = new Point(616, 356);
            ...
            cb_SandBoxSafe.Location = new Point(357, 367);
            ...
            dgv_AllItems.ShowCellToolTips = false;
            ...
            // dgv_US_Items
            // 
            dgv_US_Items.AllowUserToAddRows = false;
            dgv_US_Items.AllowUserToDeleteRows = false;
            dgv_US_Items.AllowUserToResizeColumns = false;
            ...
            dgv_US_Items.ShowCellToolTips = false;
            dgv_US_Items.ShowEditingIcon = false;
            dgv_US_Items.Size = new Size(345, 375);
            dgv_US_Items.TabIndex = 0;
            // 
            ...
            gb_US_NPCItems.Location = new Point(353, 203);
            ...
            cb_US_NPCItems.Size = new Size(90, 19);
            cb_US_NPCItems.TabIndex = 0;
            cb_US_NPCItems.Text = "NPC's Items";
            ...
            l_US_NPCItems_Dec.Text = "The items that NPC spawn with. If an NPC spawns with a vehicle, it will give them interesting physics.";
            ...
            gb_US_PropToThrow.Location = new Point(353, 133);
            ...
            l_US_PropToThrow_Dec.Text = "The Item that is thrown out of items like the Firecrackers, Gems and Rocket launcher.";
            ...
            l_US_Warning_Msg.Location = new Point(375, 45);
            l_US_Warning_Msg.Name = "l_US_Warning_Msg";
            l_US_Warning_Msg.Size = new Size(300, 85);
            ...
            // fbd_DataFileFolder
            // 
            fbd_DataFileFolder.Description = "Select the games exe folder";
